...
public class Parser {
    private static int offset = 0, line = 1;
    ...
    public static void consume(char ch) {
        char actual = peek();
        if (actual != ch) {
            System.out.println("Error: '" + ch + "' but got '" + actual + "' at line: " + Parser.line);
            System.exit(-1);
        }
        offset++;
    }
    ...
    public static float parseFloat() {
        float fParse = (float)parseDouble();
        consume('f');
        return fParse;
    }
