...
public class Window extends JFrame implements Runnable {
    ...
    public void changeScene(int scene) {
        switch (scene) {
            ...
            case 1:
                ...
                break;
            default:
                System.out.println("Nothing Scene!");
                currentScene = null;
                break;
        }
    }
    ...
    public void draw(Graphics graph) {
        ...
        graph.drawImage(doubleBufferImage, 0, 0, getWidth(), getHeight(), null);
    }

    public void renderOffscreen(Graphics graph) {
        Graphics2D graph2 = (Graphics2D)graph;
        currentScene.draw(graph2);
    }
