...
public class MenuItem extends Component {
    ...
    public void draw(Graphics2D graph2) {
    	graph2.drawImage(this.buttonSprite.image, this.x, this.y, this.width, this.height, null);
    	graph2.drawImage(myImage.image, this.x + bufferX, this.y + bufferY, myImage.width, myImage.height, null);
        if (isSelected) {
        	graph2.drawImage(hoverSprite.image, this.x, this.y, this.width, this.height, null);
        }
    }
